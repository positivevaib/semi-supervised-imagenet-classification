...
parser.add_argument('--dataroot', required = True, type = str, help = 'absolute path to dataset')
...
parser.add_argument('--trainBatch', type = int, default = 128, help = 'training batch size')
parser.add_argument('--valBatch', type = int, default = 640, help = 'validation and test batch size')
parser.add_argument('--samplesClass', type = int, default = 64, help = 'samples per class for training')
...
labeled = data.get_labeled_train_data_tensor(args.dataroot, args.samplesClass)
test_loader = data.get_labeled_test_data_loader(args.dataroot, args.valBatch)
unlabeled = data.get_unlabeled_data(args.dataroot)
