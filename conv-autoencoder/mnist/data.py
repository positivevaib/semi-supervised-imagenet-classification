...
# define function
def get_data_loaders(path, test_loader = False, train_ratio = 0.8, train_batch_size = 1, val_batch_size = 1, test_batch_size = 1):
    '''load dataset'''
    ...
    if not test_loader:
        ...
        train_data, val_data = data.random_split(dataset, (train_set_size, val_set_size))
        ...
        test_loader = data.DataLoader(dataset, batch_size = test_batch_size, shuffle = False)
